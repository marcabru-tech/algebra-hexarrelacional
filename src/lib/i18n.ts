...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'projects.empty': 'No projects saved yet. Use the "Save project" button on the Dashboard tab.',
  },
  pt_BR: {
    ...
    'prompt.project_name': 'Nome do projeto:',
    'projects.empty': 'Nenhum projeto salvo ainda. Use o botão "Salvar projeto" na aba Painel.',
  },
  zh: {
    'app.name': '六元关系显著性代数',
    'nav.dashboard': '仪表盘',
    ...
    'projects.empty': '暂无保存的项目。请在仪表盘标签页使用"保存项目"按钮。',
  },
  ja: {
    'app.name': '六元関係有意性代数',
    ...
    'prompt.project_name': 'プロジェクト名：',
    'projects.empty': 'まだプロジェクトが保存されていません。ダッシュボードタブの「プロジェクトを保存」ボタンを使用してください。',
  },
  ar: {
    ...
    'projects.empty': 'لم يتم حفظ أي مشاريع بعد. استخدم زر "حفظ المشروع" في تبويب لوحة التحكم.',
  },
};
